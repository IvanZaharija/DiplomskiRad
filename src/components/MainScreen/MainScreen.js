                ...
                <div className={classes.MainScreen}>
                    <div className={classes.Selection}>
                        ...
                        <div className={classes.PlayerCards}>
                            <SelectedCards ref="SelectedBlue" owner={"Blue"} cardsFull={this.checkIfBlueReady} getCardIds={this.returnBlueCardIds} />
                            <SelectedCards ref="SelectedRed" owner={"Red"} cardsFull={this.checkIfRedReady} getCardIds={this.returnRedCardIds} />
                        </div>
